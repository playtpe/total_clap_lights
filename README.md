...
> Άνοιγμα αυτής της σελίδας στο [https://playtpe.github.io/total_clap_lights/](https://playtpe.github.io/total_clap_lights/)
...
* αναζήτηση για **https://github.com/playtpe/total_clap_lights** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/playtpe/total_clap_lights/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/playtpe/total_clap_lights** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/playtpe/total_clap_lights/raw/master/.github/makecode/blocks.png)
